...
gpu_num = config.mengniu_yolov3_params['gpu_num']
label_path = config.mengniu_yolov3_params['label_path']
min_score=config.mengniu_yolov3_params['score']
(diff_switch,diff_iou) = config.mengniu_yolov3_params['diff_switch_iou']
(single_switch,single_iou,single_min_score) = config.mengniu_yolov3_params['single_switch_iou_minscore']
class YOLO(object):
    _defaults = {
        "model_path": config.mengniu_yolov3_params['good_model_path'],
        "anchors_path": config.mengniu_yolov3_params['anchors_path'],
        "classes_path": config.mengniu_yolov3_params['classes_path'],
        "score" : config.mengniu_yolov3_params['score'],
        "iou" : config.mengniu_yolov3_params['iou'],
        "model_image_size" : config.mengniu_yolov3_params['model_image_size'],
    }
    ...
    def detect(self,image_path):
        ...
        if self.classes is None:
            self.boxes, self.scores, self.classes = self.generate()
            logger.info("yolov3 mengniu model reload")
        import time
        time0 = time.time()
