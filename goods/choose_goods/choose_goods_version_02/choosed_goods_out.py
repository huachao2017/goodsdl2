...
def goods_out(uc_shopid,template_shop_ids,batch_id,days):
    ...
    for data in all_data[:]:
        ...
        #策略标签
        which_strategy_dict = {0:'结构品',1:'畅销品',2:'关联品',3:'品库可定商品',4:'品谱选品',5:'决策树标签选品',6:'人工临时加品',7:'网红品',101:'保留策略',201:'原陈列非保留品',301:'品库可订商品',401:'不可订货商品'}
        ...
        # close_old_connections()
        cursor_dmstore.execute(psd_sql_shops.format(week_ago,now_date,template_shop_ids,data[10]))
...
if __name__ == '__main__':
    # goods_out(806,"1284,3955,3779,1925,4076,1924,3598,223,4004",'lishu_test_201',28)
    goods_out(806,"4004",'lishu_test_201',28)
