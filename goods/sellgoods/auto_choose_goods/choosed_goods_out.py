...
def goods_out(uc_shopid,template_shop_ids,batch_id,days):
    ...
    select_sql = "select * from goods_goodsselectionhistory where uc_shopid={} and batch_id='{}' and upc is not NULL and goods_role in (1,2,4,0,3) GROUP BY mch_goods_code"
    select_sql_02 = "select mch_goods_code from goods_goodsselectionhistory where uc_shopid={} and batch_id='{}' and upc is NULL and goods_role=3 and mch_goods_code not in {}"
    ...
    cursor_ai.execute(select_sql_02.format(uc_shopid, batch_id,tuple(tt)))
...
if __name__ == '__main__':
    goods_out(806,"1284,3955,3779,1925,4076,1924,3598",'lishu_test_007',28)
