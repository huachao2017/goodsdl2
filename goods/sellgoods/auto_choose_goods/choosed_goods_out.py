...
def goods_out(uc_shopid,template_shop_ids,batch_id,days):
    ...
    select_sql = "select * from goods_goodsselectionhistory where uc_shopid={} and batch_id='{}' and upc is not NULL and goods_role in (0,2,4)"
...
if __name__ == '__main__':
    goods_out(806,"1284,3955,3779,1925,4076,1924,3598",'lishu_test_005',28)
