                ...
                for good in level.goods:
                    for gooddisplay in good.gooddisplay_inss:
                        if gooddisplay.dep == 0:
                            point1 = (shelf.height-(gooddisplay.top+level_start_height+good.height), gooddisplay.left)
                            point2 = (shelf.height-(gooddisplay.top+level_start_height), gooddisplay.left+good.width)
