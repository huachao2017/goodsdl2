...
class DataRawGoods():
    def __init__(self, mch_code, goods_name, upc, tz_display_img, corp_classify_code, spec, volume, width, height, depth,  start_sum, multiple,
        ...
        if upc_psd_nums_avg_4 is None:
            self.upc_psd_nums_avg_4 = 0
        else:
            self.upc_psd_nums_avg_4 = float(upc_psd_nums_avg_4)
        if upc_psd_nums_avg_1 is None:
            self.upc_psd_nums_avg_1 = 0
        else:
            self.upc_psd_nums_avg_1= float(upc_psd_nums_avg_1)
