...
from goods.sellgoods.salesquantity.service.order_version_7.data_util.goods_info import get_shop_order_goods
from goods.sellgoods.salesquantity.bean import taskflow
from goods.sellgoods.salesquantity.proxy import order_rule_7
import math
import demjson
import time
import traceback
def get_saleorder_ins(drg_ins, shop_id,shop_type):
    ...
    sales_order_ins.upc_psd_nums_avg_4 = drg_ins.upc_psd_nums_avg_4
    sales_order_ins.upc_psd_nums_avg_1 = drg_ins.upc_psd_nums_avg_1
...
def get_goods_batch_order_data_warhouse(batch_id,goods_order_all):
    ...
    try:
        ...
        order_data_dict = order_rule_7.rule_bingql(drg_inss=goods_order_all,order_data_dict=order_data_dict)
...
def get_order_data_warhouse(goods_order_all):
    ...
    for key in data_dict:
        ...
        if order_sale > 0 :
            # 起订量规则
            order_sale = order_rule_7.rule_start_num2(order_sale, order_data_ins.start_sum)
    ...
    order_data_inss = order_rule_7.rule_daydelivery_type(order_data_inss)
