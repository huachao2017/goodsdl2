...
class Test1(unittest.TestCase):
    ...
    #
    #     self.assertEqual(level_to_display_goods_name_str[0], '1,2,102,3,103,101,7,8,')
    #     self.assertEqual(level_to_display_goods_name_str[1], '11,12,13,14,15,16,17,18,')
    #     self.assertEqual(level_to_display_goods_name_str[2], '21,22,null,23,24,25,26,27,28,')
    #     self.assertEqual(level_to_display_goods_name_str[3], '31,32,null,33,34,35,36,37,38,')
    #     self.assertEqual(level_to_display_goods_name_str[4], '41,42,43,44,45,46,47,48,null,')
    ...
    def test_bottom_middle_level(self):
        ...
        self.assertEqual(level_to_display_goods_name_str[0], '1,2,2,3,101,5,5,6,6,6,7,8,')
        self.assertEqual(level_to_display_goods_name_str[1], '11,12,13,14,15,16,17,18,')
        self.assertEqual(level_to_display_goods_name_str[2], '21,22,null,23,24,102,26,27,')
        self.assertEqual(level_to_display_goods_name_str[3], '32,103,33,34,35,36,37,38,')
    ...
    #     level_to_display_goods_name_str = get_level_to_display_goods_name(best_candidate_shelf)
    #
    #     self.assertEqual(level_to_display_goods_name_str[0], '1,2,2,3,4,5,5,6,6,6,null,7,8,')
    #     self.assertEqual(level_to_display_goods_name_str[1], '11,12,13,14,15,16,17,18,')
